                                    ...
                                    <form  method="post" action="login"  class="user">
                                        ...
                                        <div class="form-group">
                                            <input required type="text" class="form-control form-control-user"
                                                id="exampleInputEmail" value="mylogin" aria-describedby="emailHelp"
                                                placeholder="Enter your login" name="login">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" value="internet" required name="password" class="form-control form-control-user"
